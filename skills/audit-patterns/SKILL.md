---
name: audit-patterns
description: Use when auditing pattern consistency in a scope — divergent implementations of the same concern, naming violations, import disorder, unused dependencies. Triggers on "audit patterns", "find inconsistencies", "unify conventions", "pattern review".
argument-hint: [path]
---
