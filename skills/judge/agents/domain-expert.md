...
Exclude generic code quality (that's `/qual`) and whether the feature should exist (that's `/audit-necessity`). Style preferences without functional impact are noise.
