...
This is not `/qual` (code correctness). This is not `/audit-necessity` (should it exist). This is: **given that we're building this thing, did we build it the way an expert would?**
