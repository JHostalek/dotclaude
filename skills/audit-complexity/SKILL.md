...
- **Surface compression** (low yield, high count). Stale `# noqa:`, single-use intermediates, in-place-obvious constants, multi-line literals that fit on fewer lines.
...
- **Test infra** heavier than the code under test. Cutting the tests themselves is `audit-tests`; you own the scaffolding around them.
